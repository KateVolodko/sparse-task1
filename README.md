# Задача 1: Sparse File Creator

**Тема:** работа с файлами - open, read, write, seek.

**Выполнила:** Володько Екатерина МЕН-420802 (ФТ-402)
...
6. Программой `stat` вывести реальный размер файлов A, A.gz, B, B.gz, C, D
...
| `src/Makefile` | Сборка программы |
| `scripts/create_test_file.sh` | Создание тестового файла A |
| `runme.sh` | Основной скрипт тестирования |
